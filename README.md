...
- [OpenMagic](https://github.com/Kalmuraee/OpenMagic) — Open-source AI coding toolbar for any web app. Run `npx openmagic`, select a UI element in the browser, describe a change, review the diff, and apply verified edits to the real source code. Supports multiple LLM providers and local coding CLIs.
